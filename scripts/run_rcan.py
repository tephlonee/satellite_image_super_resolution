...
scripts/run_rcan.py
--------------------
Entry point for training the RCAN super-resolution model on SAR images.
...
from train.train_rcan import RCANTrainer

logger = get_logger(__name__)


def parse_args():
    parser = argparse.ArgumentParser(description="Train RCAN for SAR Super-Resolution")
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("SAR Super-Resolution | RCAN Training")
    logger.info("=" * 60)
    ...
    best_ckpt = f"{cfg.train_rcan.checkpoint_dir}/best_model.pth"
